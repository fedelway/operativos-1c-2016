...
//Ver si después hay que borrar el include del metadata_program..
...
//t_puntero_instruccion socketes_irAlLabel(t_nombre_etiqueta etiqueta); TODO: ver definiciones
